...
benchmark_single_phase() {
	...
	solver_prototxt="$des_dir"/"$solver_prototxt_prefix"_"$phase_name_dir"_"$phase_id"_num_output_"$num_output".prototxt
		...
		--weights=$source_dir/original_100run_pretrained/phase$phase_id/"$solver_prototxt_prefix"_"$phase_name_dir"_"$phase_id"_num_output_"$num_output"_lr1_iter_5000.caffemodel.h5

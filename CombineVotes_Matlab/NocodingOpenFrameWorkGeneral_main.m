...
DNNToTest = {'ILSVRC2012-VGG-CNN-S'}; %try to only use one DNN each time, otherwise, it will be very complecate 'ILSVRC2012-VGG-CNN-S',
%=============================================================
...
%     experiment_flag = DIR_PATHS.BASELINE_TEST_DIR;
    ...
    retrain_ids = 0 : DNN_MODELS{DNN_ID}.NUM_RETRAIN;
    iterations = [DNN_MODELS{DNN_ID}.MAX_NUM_ITERATION ones(1,DNN_MODELS{DNN_ID}.NUM_RETRAIN) * DNN_MODELS{DNN_ID}.RETRAIN_MAX_NUM_ITERATION];

...
function [ensemble_performance,final_pred] = EstimateBAEAOA_B(pred_phases, ground_truth, Ensemble_Results_Setting)
...
%     disp([ 'random_num_phase = ' num2str(k) ' ------------ ']);
    [ensmeble_accuracy(:,k), oracle_accuracy(:,k), final_pred] ...
        = MakeEnsembleOriginal100Run_A(pred_phases, truth, Ensemble_Results_Setting.Report_Last_OR_All);
%     toc
end

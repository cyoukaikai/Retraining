...
function final_results  = MakeEnsembleLearningNocodingWeighted_B(pred_phases,weights, ground_truth, ResultingFile,  Ensemble_Results_Setting) 
    ...
    [ensemble_performance,final_pred] = EstimateBAEAOAWeighted_B(pred_phases, weights, ground_truth, Ensemble_Results_Setting);

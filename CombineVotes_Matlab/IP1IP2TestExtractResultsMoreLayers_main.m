...
Directory = { 
            { 'ip2_1','ip1_1_ip2_1','conv2_1_ip1_1_ip2_1', 'ip2_2.5','ip1_2.5_ip2_2.5','conv2_2.5_ip1_2.5_ip2_2.5','ip2_10','ip1_10_ip2_10','conv2_10_ip1_10_ip2_10'}, ...  %MNIST done 2 3 4 5 7
             { 'ip2_1','ip1_1_ip2_1','conv3_1_ip1_1_ip2_1', 'ip2_2.5','ip1_2.5_ip2_2.5','conv3_2.5_ip1_2.5_ip2_2.5','ip2_10','ip1_10_ip2_10','conv3_10_ip1_10_ip2_10'}, ... 'SVHN-QUICK' 
                    {} ,... %'CIFAR10-FULL'
                     {'ip2_1','ip1_1_ip2_1','conv3_1_ip1_1_ip2_1', 'ip2_2.5','ip1_2.5_ip2_2.5',  'conv3_2.5_ip1_2.5_ip2_2.5','ip2_10','ip1_10_ip2_10', 'conv3_10_ip1_10_ip2_10' } ,... %'CIFAR10-QUICK'  
                     { 'ccp6_1','ccp5_1_ccp6_1','conv3_1_ccp5_1_ccp6_1','ccp6_2.5', 'ccp5_2.5_ccp6_2.5','conv3_2.5_ccp5_2.5_ccp6_2.5','ccp6_10','ccp5_10_ccp6_10','conv3_10_ccp5_10_ccp6_10' } ,... %'CIFAR100-NIN'
                        {'ip2_1','ip1_1_ip2_1','conv3_1_ip1_1_ip2_1', 'ip2_2.5','ip1_2.5_ip2_2.5',  'conv3_2.5_ip1_2.5_ip2_2.5','ip2_10','ip1_10_ip2_10', 'conv3_10_ip1_10_ip2_10' }, ...  %'CIFAR100-QUICK' 75    10  50  33  25 5   4   3  2
                         ...
                         {'fc8_1','fc7_1_fc8_1','fc6-1-fc7-1-fc8-1','fc8_2.5','fc7-2.5-fc8-2.5','fc6-2.5-fc7-2.5-fc8-2.5','fc8_10','fc7_10_fc8_10','fc6-10-fc7-10-fc8-10'} ,... %'FLOWER102-ALEXNET-Scratch' ,'fc8_7.5'
                    {} ,... %'FLOWER102-NIN-finetune'
...
DNNToTest = { 'MNIST','SVHN-QUICK','CIFAR10-QUICK','CIFAR100-NIN', 'CIFAR100-QUICK','CIFAR100-DENSENET','FLOWER102-ALEXNET-SCRATCH','ILSVRC2012-NIN'};
%============================================================='CIFAR100-QUICK',
...
inds = (1:size(results_EA,1))';
results_EA =  [ inds results_EA ];
disp('---------------------------------------------------------------------EA');
disp(results_EA) %show the results
 dlmwrite([file_name '-EA1.txt'],results_EA(1:3,:),'delimiter',' ','precision','%.2f');

 dlmwrite([file_name '-EA2.txt'],results_EA(4:6,:),'delimiter',' ','precision','%.2f');
  dlmwrite([file_name '-EA3.txt'],results_EA( 7:9,:),'delimiter',' ','precision','%.2f');



disp('---------------------------------------------------------------------BA');
results_BA =  [ inds results_BA ];
disp(results_BA) %show the results
 dlmwrite([file_name '-BA1.txt'],results_BA(1:3,:),'delimiter',' ','precision','%.2f');

 dlmwrite([file_name '-BA2.txt'],results_BA(4:6,:),'delimiter',' ','precision','%.2f');
  dlmwrite([file_name '-BA3.txt'],results_BA( 7:9,:),'delimiter',' ','precision','%.2f');
  
disp('---------------------------------------------------------------------Q');
results_Q =  [ inds results_Q ];
disp(results_Q) %show the results
 dlmwrite([file_name '-Q1.txt'],results_Q(1:3,:),'delimiter',' ','precision','%.3f');

 dlmwrite([file_name '-Q2.txt'],results_Q(4:6,:),'delimiter',' ','precision','%.3f');
  dlmwrite([file_name '-Q3.txt'],results_Q( 7:9,:),'delimiter',' ','precision','%.3f');

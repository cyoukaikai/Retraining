...
ECOC_Phases_To_Test = {
                    {[2 3 ]}, ...  %MNIST done4 5 7
                    { [ 2 3]}, ... %'SVHN-QUICK' done 2 3 4 5 10 
                    {[2 4]} ,... %'CIFAR10-FULL'
                     {[2 7]} ,... %'CIFAR10-QUICK' 2 10
                     {[2 95]} ,... %'CIFAR100-NIN' 2, 3, 25,33,50,75,95
                        {[ 2  ]}, ...  %'CIFAR100-QUICK' 75    10  50  33  25 5   4   3  2
                         {[2, 3,5, 25,33,50, 60,75,80,90,95]} ,... %'CIFAR100-DenseNet'
                         {[ 3]} ,... %'FLOWER102-ALEXNET-Scratch'  51 , 34, 10, 102, 95, 5, , 2
                    {[95 2]} ,... %'FLOWER102-NIN-finetune' 51 , 34, 10, 5, 3, 102,  95,
                    {} ...  %'ILSVRC2012-NIN'
                     {[95 2]} ,... %'FLOWER102-ALEXNET-finetune' 51 , 34, 10, 5, 3, 102,  95,
                    };
...
DNNToTest = {'CIFAR100-QUICK'}; % 'CIFAR100-NIN', 'CIFAR10-QUICK','CIFAR10-FULL', 
% ,'CIFAR100-NIN'
...
%    for foldID =3 : 4 % 2 : NumberOfFoldForCrossValidation(DNN_ID)
       
       
    %     DIR_PATHS.BASELINE_TEST_DIR = 'BASELINE'; 
%         ECOC_codeword_prototxt_file_name_old = [ DIR_PATHS.Preprocessed_Prediction_DIR '/'...
...
%          DIR_PATHS.BASELINE_TEST_DIR =['ImbalancedClass' num2str(foldID)]
        ...
        CreateDirThreeLevel_A(DIR_PATHS.Preprocessed_Prediction_DIR, DNN_MODELS{DNN_ID}.DNN, DIR_PATHS.BASELINE_TEST_DIR);
    
%          ECOC_codeword_prototxt_file_name_new = [ DIR_PATHS.Preprocessed_Prediction_DIR '/'...
%                  DNN_MODELS{DNN_ID}.DNN '/'  DIR_PATHS.BASELINE_TEST_DIR '/' ...
%                  'ECOC_NaryECOC_CODEWORD.mat' ];
%         copyfile( ECOC_codeword_prototxt_file_name_old, ECOC_codeword_prototxt_file_name_new);
%         
